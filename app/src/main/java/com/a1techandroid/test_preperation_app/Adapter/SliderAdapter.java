...
public class SliderAdapter extends
    ...
    public SliderAdapter(Context context, ArrayList<SliderItem> list) {
    ...
    public SliderAdapterVH onCreateViewHolder(ViewGroup parent) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.slider_adapter_view, null);
    ...
    public void onBindViewHolder(SliderAdapterVH viewHolder, final int position) {
        ...
        viewHolder.imageViewBackground.setImageDrawable(sliderItem.getImage());
